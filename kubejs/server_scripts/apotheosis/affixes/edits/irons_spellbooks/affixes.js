    ...
    let tweaks = [
        {
            ...
            types: ["helmet", "chestplate", "leggings", "boots", "shield", "sword", "trident"],
        },
        {
        ...
        // There used to be a gem for each spell power but they were removed in an iron's spellbooks update
    ];
